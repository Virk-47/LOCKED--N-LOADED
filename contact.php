								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input name="msg" id="message" class="form-control" placeholder="Say something about us"></input>
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-sm-12">
...
if(isset($_POST['sub'])){
	...
	$msg=$_POST['msg'];
$a="INSERT INTO contact(FName,LName,EmailId,Subject,Message)
values('$fname','$lname','$email','$subject','$msg')";
